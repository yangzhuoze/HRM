...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.gridLayout.addWidget(self.label_positiontitle, 2, 2, 1, 1)
        self.input_positiontitle = QtWidgets.QComboBox(Dialog)
        self.input_positiontitle.setObjectName("input_positiontitle")
        self.gridLayout.addWidget(self.input_positiontitle, 2, 3, 1, 1)
    ...
    def retranslateUi(self, Dialog):
        ...
        self.label_positiontitle.setText(_translate("Dialog", "TextLabel"))
