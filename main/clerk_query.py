...
class clerk_query_event(QDialog, Ui_Dialog):
    ...
    def __init__(self, clerk, parent=None):
        ...
        self.input_positioncat.setEnabled(False)
        self.input_position.setEnabled(False)
        self.input_positiontitle.setEnabled(False)
        self.input_salary.setEnabled(False)
        ...
        self.input_nation.setEnabled(False)
        self.input_ethnicity.setEnabled(False)
        self.input_faith.setEnabled(False)
        self.input_politicalstatus.setEnabled(False)
        self.input_education.setEnabled(False)
        self.input_educationtime.setEnabled(False)
